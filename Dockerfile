...
RUN if [ "$MODEL_TYPE" = "qwen-image-edit" ]; then \
      comfy model download --url https://huggingface.co/Comfy-Org/Qwen-Image-Edit_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_edit_2511_fp8mixed.safetensors --relative-path models/diffusion_models --filename qwen_image_edit_2511_fp8mixed.safetensors && \
